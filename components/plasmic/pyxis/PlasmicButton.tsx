...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 9S3piU8qHY8/css
  ...
  return (
    ...
    >
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__cjQp2)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon3Icon
                className={classNames(projectcss.all, sty.svg__nzkym)}
                role={"img"}
              />
            ),
      ...
      {p.renderPlasmicSlot({
        defaultContents: (
          <TimeBarIcon
            className={classNames(projectcss.all, sty.svg__z2YKc)}
            role={"img"}
          />
        ),

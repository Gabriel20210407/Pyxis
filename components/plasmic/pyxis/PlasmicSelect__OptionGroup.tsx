...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: kx5NwH8Zc5J/css

import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: aY8ysst3jje/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__shFLt)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__yzvPt)}
              />
            </React.Fragment>
          ),
          value: args.children

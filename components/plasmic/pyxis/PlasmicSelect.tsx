...
import Select__Option from "../../Select__Option"; // plasmic-import: N2R21VwUsi2/component

import "@plasmicapp/react-web/lib/plasmic.css";

import projectcss from "./plasmic_pyxis.module.css"; // plasmic-import: ujjYdWMUfC69RDjGJ3P7gT/projectcss
import sty from "./PlasmicSelect.module.css"; // plasmic-import: aY8ysst3jje/css

import ChevronDownsvgIcon from "./icons/PlasmicIcon__ChevronDownsvg"; // plasmic-import: Ov0omtaDLNI/icon
import ChevronUpsvgIcon from "./icons/PlasmicIcon__ChevronUpsvg"; // plasmic-import: FjbSosPPk1e/icon
  ...
  if (!("children" in props)) {
    props = {
      ...
      children: (
        <React.Fragment>
          <Select__Option
            className={classNames("__wab_instance", sty.option___962Ei)}
            value={"value1" as const}
          >
            {"Option 1"}
          </Select__Option>
          ...
          <Select__Option
            className={classNames("__wab_instance", sty.option__r7Slp)}
            value={"value2" as const}
          >
            {"Option 2"}
          </Select__Option>

...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: FQfuE_bu4a6/css

import SquaresvgIcon from "./icons/PlasmicIcon__Squaresvg"; // plasmic-import: hdM95WqdRCh/icon
import SquareCheckFilledsvgIcon from "./icons/PlasmicIcon__SquareCheckFilledsvg"; // plasmic-import: xrMxc5POmZ-/icon
import SquareMinussvgIcon from "./icons/PlasmicIcon__SquareMinussvg"; // plasmic-import: Rf5v-YEDGCZ/icon
